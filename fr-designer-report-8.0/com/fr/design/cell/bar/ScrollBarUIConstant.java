...
public class ScrollBarUIConstant
{
    ...
    public static final ColorUIResource NORMAL_SCROLL_BAR_COLOR = new ColorUIResource(0xe2e2e2);
    public static final ColorUIResource ROLL_OVER_SCROLL_BAR_COLOR = new ColorUIResource(0xd2d2d2);
