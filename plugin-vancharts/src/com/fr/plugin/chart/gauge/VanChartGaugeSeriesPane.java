...
public class VanChartGaugeSeriesPane extends VanChartAbstractPlotSeriesPane {
    ...
    private UIButtonGroup gaugeLayout;//²¼¾Ö£ººáÏò¡¢×ÝÏò

    private ColorSelectBox hingeColor;//ÊàÅ¦ÑÕÉ«
    private ColorSelectBox hingeBackgroundColor;//ÊàÅ¦±³¾°ÑÕÉ«
    private ColorSelectBox needleColor;//Ö¸ÕëÑÕÉ«
    private ColorSelectBox paneBackgroundColor;//µ×ÅÌ±³¾°ÑÕÉ«

    private ColorSelectBox slotBackgroundColor;//¿Ì¶È²ÛÑÕÉ«

    private UIButtonGroup rotate;//Ðý×ª·½Ïò
    private ColorSelectBox innerPaneBackgroundColor;//ÄÚµ×ÅÌ±³¾°ÑÕÉ«
