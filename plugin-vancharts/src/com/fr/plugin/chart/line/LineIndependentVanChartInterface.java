 ...
 */
public class LineIndependentVanChartInterface extends AbstractIndependentChartUI {
    @Override
    ...
    public ConditionAttributesPane getPlotConditionPane(Plot pot){
        return new VanChartLineConditionPane();
    }
