...
public class FRGraphics2D extends Graphics2D {
	Graphics2D g2d;
	
	public FRGraphics2D (Graphics2D sg2d) {
		this.g2d = sg2d;
	}
	@Override
	...
	public void drawString(String str, int x, int y) {
		GraphHelper.drawString(g2d, str, x, y);
	}
	...
	public Graphics create() {
		return new FRGraphics2D((Graphics2D) g2d.create());
	}
