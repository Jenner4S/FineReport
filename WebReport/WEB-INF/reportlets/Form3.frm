...
<Query>
<![CDATA[SELECT * FROM `columns_priv`]]></Query>
</TableData>
...
<RowData>
<![CDATA[Ha9F4g",P\:FC>d&Z:br.G*%>qk*5B_teEJm&/V$!_!(~
]]></RowData>
</TableData>
</TableDataMap>
...
<Chart name="默认" chartClass="com.fr.solution.plugin.chart.echarts.base.NewChart">
<Chart class="com.fr.solution.plugin.chart.echarts.base.NewChart">
<GI>
<AttrBackground>
...
<Attr4MapChart Title="新建图的表标题" SubTitle="默认副从标题大神" IsShow="true"/>
</MapChartTitle>
<Plot class="com.fr.solution.plugin.chart.echarts.core.map.ChineseMapPlot">
<GI>
<AttrBackground>
<Background name="NullBackground"/>
<Attr shadow="false"/>
...
<BoundsAttr x="0" y="0" width="960" height="538"/>
</Widget>
...
<Attr4MapChart Title="默认主标题" SubTitle="默认副标题" IsShow="false"/>
</MapChartTitle>
<Plot class="com.fr.solution.plugin.chart.echarts.core.map.ChineseMapPlot">
<GI>
<AttrBackground>
