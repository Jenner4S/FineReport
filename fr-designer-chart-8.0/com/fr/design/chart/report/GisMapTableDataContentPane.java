...
public class GisMapTableDataContentPane extends FurtherBasicBeanPane
    implements UIObserver
{
    private class InnerTableEditor extends UITableEditor
    {
        ...
        final GisMapTableDataContentPane this$0;
        ...
        {
            this$0 = GisMapTableDataContentPane.this;
            super();
        }
    ...
    public GisMapTableDataContentPane()
    {
        ...
        UILabel uilabel = new UILabel((new StringBuilder()).append(Inter.getLocText("Chart-Select_Data_Set")).append(":").toString(), 2);
...
;
    ...
    public void populateBean(GisMapTableDefinition gismaptabledefinition)
    {
        ...
        if(gismaptabledefinition instanceof GisMapTableDefinition)
        {
            ...
            fromTableData.populateBean((NameTableData)gismaptabledefinition1.getTableData());
    ...
    public GisMapTableDefinition updateBean()
    {
        ...
        if(tabledatawrapper == null || addressBox.getSelectedItem() == null)
            return null;
        gismaptabledefinition.setTableData(new NameTableData(tabledatawrapper.getTableDataName()));
