...
public class BarPlotPane4ToolBar extends PlotPane4ToolBar
{
    ...
    public BarPlotPane4ToolBar(ChartDesigner chartdesigner)
    {
        super(chartdesigner);
    }
    ...
    protected List initDemoList()
    {
        ...
        ChartDesignerImagePane chartdesignerimagepane = new ChartDesignerImagePane(getTypeIconPath(), 0, Inter.getLocText("FR-Chart-Type_Bar"), this);
