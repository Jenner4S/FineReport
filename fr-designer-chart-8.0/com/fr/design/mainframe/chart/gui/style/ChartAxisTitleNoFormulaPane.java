...
public class ChartAxisTitleNoFormulaPane extends BasicPane
{
    ...
    private void initComponents()
    {
        ...
        isAxisTitleVisable.addActionListener(new ActionListener() {
            ...
            final ChartAxisTitleNoFormulaPane this$0;
            ...
            {
                this$0 = ChartAxisTitleNoFormulaPane.this;
                super();
            }
        }
);
    ...
    public void update(Axis axis)
    {
        if(isAxisTitleVisable.isSelected())
        {
            if(axis.getTitle() == null)
            {
                ...
                axis.setTitle(title);
                axisTitleContentPane.setText(Utils.objectToString(title.getTextObject()));
                axisTitleAttrPane.populate(FRFont.getInstance("Microsoft YaHei", 0, 9F));
            }
            Title title1 = axis.getTitle();
            title1.setTitleVisible(true);
            title1.setTextObject(axisTitleContentPane.getText());
