...
public class ChartTitlePaneNoFormula extends BasicScrollPane
{
    private class ContentPane extends JPanel
    {

        private static final long serialVersionUID = 0xa66919fceeb528f9L;
        final ChartTitlePaneNoFormula this$0;
        ...
        public ContentPane()
        {
            this$0 = ChartTitlePaneNoFormula.this;
            super();
            initComponents();
        }
    }
    ...
    public ChartTitlePaneNoFormula()
    {
    }
    ...
    public void updateBean(Chart chart)
    {
        ...
        String s = titleContent.getText();
        title.setTextObject(s);
        TextAttr textattr = title.getTextAttr();
        if(textattr == null)
            textattr = new TextAttr();
